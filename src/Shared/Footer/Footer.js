...
const Footer = () => {
  return (
    <section class="pt-16 pb-7  shadow-2xl shadow-dark-mid">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
          <div>
            <h2 className="text-3xl font-bold text-accent-400">Book Nookery</h2>
          </div>
          <div class="flex items-center gap-4">
            <a
              href="javascript:;"
              class="p-3 rounded-full bg-accent-400  text-2xl group transition-all duration-500 hover:bg-amber-500 hover:text-white focus-within:outline-0 focus-within:bg-amber-500 focus-within:text-white"
            >
              <FaFacebookF />
            </a>
            <a
          ...
          <div class="w-full lg:max-w-md max-lg:mx-auto ">
            ...
            <div class="bg-gray-800 rounded-3xl p-5">
              <form action="#" class="flex flex-col gap-5">
                <div class="relative">
                  <label class="flex  items-center mb-2 text-gray-400 text-base font-medium">
                    Email
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="harsh@InnRecruit.com"
                    required=""
                  />
                </div>
                <div class="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                  <div class="flex items-start black">
                    ...
                    >
                      I agree with{" "}
                      <a href="javascript:;" class="text-accent-400">
                        Privacy Policy
                      </a>{" "}
                      and{" "}
                      <a href="javascript:;" class="text-accent-400">
        ...
        <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
          <span class="text-sm font-normal text-gray-400">
            <a href="https://InnRecruit.io/" class="">
              ©InnRecruit
            </a>{" "}
